...
class Segmentor(object):
    def __init__(self, db_path):
        self.query = DatabaseQuery(db_path)
        self.word_len = 4
        self.process_list = []
...
#     seg.send(test_str)
    ...
    print("processing speed is %f" % (float(len(sample_str+second_str))/(end_real - start_real)))
